        ...
        for proof in ex["proofs"]:
            ...
            for node in tree.traverse():
                ...
                if self.split == "train":
                    ...
                    if "does " in node.sent:
                        create_negative(premises, node.sent.replace("does ", "does not "))
                    elif "do " in node.sent:
                        create_negative(premises, node.sent.replace("do ", "do not "))
                    elif "can " in node.sent:
                        create_negative(premises, node.sent.replace("can ", "cannot "))
                    elif "is " in node.sent:
                        create_negative(premises, node.sent.replace("is ", "is not"))
                    elif "are " in node.sent:
                        create_negative(premises, node.sent.replace("are ", "are not"))

                    if node.sent.startswith("i think "):
                        create_negative(
                            premises, node.sent.replace("i think ", "i don't think ")
                        )
                    else:
                        create_negative(premises, f"i think {node.sent}")
